package fyp.saira.driverhiring.PhoneVerify;
...
import fyp.saira.driverhiring.SignupPage;
...
public class ActivityPhoneVerify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phoneverify);
            ...
            public void onClick(View v) {
                try {
                    if (!isConnected()) {
                        ...
                        Snackbar.make(v, "Sorry there was a problem with your network", Snackbar.LENGTH_LONG)
    ...
    private void goToHome() {
        Intent intent = new Intent(ActivityPhoneVerify.this, SignupPage.class);
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        ...
                        if (e instanceof FirebaseAuthInvalidCredentialsException) {
                            // Invalid request
                            Toast.makeText(ActivityPhoneVerify.this, "Invalid credential", Toast.LENGTH_SHORT).show();
                        } else if (e instanceof FirebaseTooManyRequestsException) {
                            // SMS quota exceeded
                            Toast.makeText(ActivityPhoneVerify.this, "Limit Reached Try Again In a few Hours", Toast.LENGTH_SHORT).show();
                        }
                    }
